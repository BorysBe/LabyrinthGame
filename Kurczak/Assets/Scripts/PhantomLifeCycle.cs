...
public class PhantomLifeCycle : ObjectLifeCycle, IPlayable
{
    ...
    public override void Play()
    {
        ...
        {
            var woundArea = EnemyFactory.Instance.Spawn(PrefabType.PhantomWoundArea, transform.position, null);
    ...
    {
        PhantomWoundAreaLifeCycle[] images = transform.GetComponentsInChildren<PhantomWoundAreaLifeCycle>();
