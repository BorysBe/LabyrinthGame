...
public abstract class UpdateRotationInTimeMonobehaviour : MonoBehaviour, IPlayable
{
    ...
    [SerializeField] protected int timeToFullRotationMs = 100;
    ...
    {
        _timer = new MonoBehaviourUpdateTimer(timeToFullRotationMs);
